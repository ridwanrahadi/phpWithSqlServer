 ...
 <script src="https://code.jquery.com/jquery-3.3.1.min.js"></script>
  ...
  <script>
   $(document).ready(function(){
      ...
      <body>
         <h3 align="center">HISTORY PENJUALAN</h3>
          <div class="container">
              <div class="jumbotron">
  ...
  <div class="form-group">
    <label >Input :</label>
    <input type="form-text" class="form-control" name="txtcari2" id="txtcari2" value="<?php echo $nmcust; ?>" placeholder="Nama Customer">
  </div>

  <div class="form-group">
    <label >Input :</label>
    <input type="form-text" class="form-control" name="txtcari3" id="txtcari3" value="<?php echo $kdsales; ?>" placeholder="Kode Sales">
  </div>
  ...
  if (isset($_POST['cari'])) {
    ...
    $mySql = "SELECT TOP 1000 TblFak.NoBukti, TblFak.Tgl, TblFak.KdCust, TblFak.NmCust, TblFak.KdSales, TblFakDtl.KdBrg,TblFakDtl.NmBrg, TblFakDtl.Qty, TblFakDtl.Satuan, TblFakDtl.Hrg, TblFakDtl.PrsDisc, TblFakDtl.PrsDisc2, TblFakDtl.PrsDisc3, TblFakDtl.Jumlah, TblFak.Kirim, TblFak.NonStock, TblFak.Cetak,tblIvMst.Type
...
Where TblFak.Tgl between '".$tglAwal."' AND '".$tglAkhir."'  and TblFakDtl.KdBrg like '%".$txtcari1."%' and TblFak.NmCust like '%".$txtcari2."%' and TblFak.KdSales like '".$txtcari3."' and TblFak.NonStock='0' and  tblIvMst.Type='D4'
ORDER by TblFak.Tgl ASC ";
$myQry = mssql_query($mySql, $koneksidb)  or die ("Query 1 salah : ".mysql_error());
    }elseif($txtcari1 !='' AND $txtcari2 !=''){
      $mySql = "SELECT TOP 1000 TblFak.NoBukti, TblFak.Tgl, TblFak.KdCust, TblFak.NmCust, TblFak.KdSales, TblFakDtl.KdBrg,TblFakDtl.NmBrg, TblFakDtl.Qty, TblFakDtl.Satuan, TblFakDtl.Hrg, TblFakDtl.PrsDisc, TblFakDtl.PrsDisc2, TblFakDtl.PrsDisc3, TblFakDtl.Jumlah, TblFak.Kirim, TblFak.NonStock, TblFak.Cetak,tblIvMst.Type
FROM TblFak INNER JOIN TblFakDtl ON TblFak.NoBukti = TblFakDtl.NoBukti INNER JOIN tblIvMst ON TblFakDtl.KdBrg = tblIvMst.KdBrg
Where TblFak.Tgl between '".$tglAwal."' AND '".$tglAkhir."' and TblFakDtl.KdBrg like '%".$txtcari1."%' and TblFak.NmCust like '%".$txtcari2."%' and TblFak.NonStock='0' and  tblIvMst.Type='D4'
ORDER by TblFak.Tgl DESC ";
$myQry = mssql_query($mySql, $koneksidb)  or die ("Query 1 salah : ".mysql_error());
      }elseif($txtcari1 !='' AND $txtcari3 !=''){
      $mySql = "SELECT TOP 1000 TblFak.NoBukti, TblFak.Tgl, TblFak.KdCust, TblFak.NmCust, TblFak.KdSales, TblFakDtl.KdBrg,TblFakDtl.NmBrg, TblFakDtl.Qty, TblFakDtl.Satuan, TblFakDtl.Hrg, TblFakDtl.PrsDisc, TblFakDtl.PrsDisc2, TblFakDtl.PrsDisc3, TblFakDtl.Jumlah, TblFak.Kirim, TblFak.NonStock, TblFak.Cetak,tblIvMst.Type
FROM TblFak INNER JOIN TblFakDtl ON TblFak.NoBukti = TblFakDtl.NoBukti INNER JOIN tblIvMst ON TblFakDtl.KdBrg = tblIvMst.KdBrg
Where TblFak.Tgl between '".$tglAwal."' AND '".$tglAkhir."' and TblFakDtl.KdBrg like '%".$txtcari1."%' and TblFak.KdSales like '".$txtcari3."' and TblFak.NonStock='0' and  tblIvMst.Type='D4' 
ORDER by TblFak.Tgl DESC ";
$myQry = mssql_query($mySql, $koneksidb)  or die ("Query 1 salah : ".mysql_error());
      }elseif($txtcari2 !='' AND $txtcari3 !=''){
      $mySql = "SELECT TOP 1000 TblFak.NoBukti, TblFak.Tgl, TblFak.KdCust, TblFak.NmCust, TblFak.KdSales, TblFakDtl.KdBrg,TblFakDtl.NmBrg, TblFakDtl.Qty, TblFakDtl.Satuan, TblFakDtl.Hrg, TblFakDtl.PrsDisc, TblFakDtl.PrsDisc2, TblFakDtl.PrsDisc3, TblFakDtl.Jumlah, TblFak.Kirim, TblFak.NonStock, TblFak.Cetak,tblIvMst.Type
FROM TblFak INNER JOIN TblFakDtl ON TblFak.NoBukti = TblFakDtl.NoBukti INNER JOIN tblIvMst ON TblFakDtl.KdBrg = tblIvMst.KdBrg
Where TblFak.Tgl between '".$tglAwal."' AND '".$tglAkhir."' and TblFak.NmCust like '%".$txtcari2."%' and TblFak.KdSales like '".$txtcari3."' and TblFak.NonStock='0' and  tblIvMst.Type='D4'
ORDER by TblFak.Tgl DESC ";
$myQry = mssql_query($mySql, $koneksidb)  or die ("Query 1 salah : ".mysql_error());
      }elseif($txtcari1 !=''){
      $mySql = "SELECT TOP 1000 TblFak.NoBukti, TblFak.Tgl, TblFak.KdCust, TblFak.NmCust, TblFak.KdSales, TblFakDtl.KdBrg,TblFakDtl.NmBrg, TblFakDtl.Qty, TblFakDtl.Satuan, TblFakDtl.Hrg, TblFakDtl.PrsDisc, TblFakDtl.PrsDisc2, TblFakDtl.PrsDisc3, TblFakDtl.Jumlah, TblFak.Kirim, TblFak.NonStock, TblFak.Cetak,tblIvMst.Type
FROM TblFak INNER JOIN TblFakDtl ON TblFak.NoBukti = TblFakDtl.NoBukti INNER JOIN tblIvMst ON TblFakDtl.KdBrg = tblIvMst.KdBrg
Where TblFak.Tgl between '".$tglAwal."' AND '".$tglAkhir."' and TblFakDtl.KdBrg like '%".$txtcari1."%' and TblFak.NonStock='0' and  tblIvMst.Type='D4'
ORDER by TblFak.Tgl DESC ";
$myQry = mssql_query($mySql, $koneksidb)  or die ("Query 1 salah : ".mysql_error());
      }elseif($txtcari2 !=''){
      $mySql = "SELECT TOP 1000 TblFak.NoBukti, TblFak.Tgl, TblFak.KdCust, TblFak.NmCust, TblFak.KdSales, TblFakDtl.KdBrg,TblFakDtl.NmBrg, TblFakDtl.Qty, TblFakDtl.Satuan, TblFakDtl.Hrg, TblFakDtl.PrsDisc, TblFakDtl.PrsDisc2, TblFakDtl.PrsDisc3, TblFakDtl.Jumlah, TblFak.Kirim, TblFak.NonStock, TblFak.Cetak,tblIvMst.Type
FROM TblFak INNER JOIN TblFakDtl ON TblFak.NoBukti = TblFakDtl.NoBukti INNER JOIN tblIvMst ON TblFakDtl.KdBrg = tblIvMst.KdBrg
Where TblFak.Tgl between '".$tglAwal."' AND '".$tglAkhir."' and TblFak.NmCust like '%".$txtcari2."%' and TblFak.NonStock='0' and  tblIvMst.Type='D4'
ORDER by TblFak.Tgl DESC ";
$myQry = mssql_query($mySql, $koneksidb)  or die ("Query 1 salah : ".mysql_error());
      }elseif($txtcari3 !=''){
      $mySql = "SELECT TOP 1000 TblFak.NoBukti, TblFak.Tgl, TblFak.KdCust, TblFak.NmCust, TblFak.KdSales, TblFakDtl.KdBrg,TblFakDtl.NmBrg, TblFakDtl.Qty, TblFakDtl.Satuan, TblFakDtl.Hrg, TblFakDtl.PrsDisc, TblFakDtl.PrsDisc2, TblFakDtl.PrsDisc3, TblFakDtl.Jumlah, TblFak.Kirim, TblFak.NonStock, TblFak.Cetak,tblIvMst.Type
FROM TblFak INNER JOIN TblFakDtl ON TblFak.NoBukti = TblFakDtl.NoBukti INNER JOIN tblIvMst ON TblFakDtl.KdBrg = tblIvMst.KdBrg
Where TblFak.Tgl between '".$tglAwal."' AND '".$tglAkhir."' and TblFak.KdSales like '".$txtcari3."' and TblFak.NonStock='0' and  tblIvMst.Type='D4'
ORDER by TblFak.Tgl DESC ";
$myQry = mssql_query($mySql, $koneksidb)  or die ("Query 1 salah : ".mysql_error());
      }else{
        $mySql = "SELECT TOP 1000 TblFak.NoBukti, TblFak.Tgl, TblFak.KdCust, TblFak.NmCust, TblFak.KdSales, TblFakDtl.KdBrg,TblFakDtl.NmBrg, TblFakDtl.Qty, TblFakDtl.Satuan, TblFakDtl.Hrg, TblFakDtl.PrsDisc, TblFakDtl.PrsDisc2, TblFakDtl.PrsDisc3, TblFakDtl.Jumlah, TblFak.Kirim, TblFak.NonStock, TblFak.Cetak,tblIvMst.Type
FROM TblFak INNER JOIN TblFakDtl ON TblFak.NoBukti = TblFakDtl.NoBukti INNER JOIN tblIvMst ON TblFakDtl.KdBrg = tblIvMst.KdBrg 
Where TblFak.Tgl between '".$tglAwal."' AND '".$tglAkhir."' and TblFak.NonStock='0' and  tblIvMst.Type='D4'
ORDER by TblFak.Tgl DESC ";
$myQry = mssql_query($mySql, $koneksidb)  or die ("Query 1 salah : ".mysql_error());
      }
}else{
  $mySql = "SELECT TOP 10 TblFak.NoBukti, TblFak.Tgl, TblFak.KdCust, TblFak.NmCust, TblFak.KdSales, TblFakDtl.KdBrg,TblFakDtl.NmBrg, TblFakDtl.Qty, TblFakDtl.Satuan, TblFakDtl.Hrg, TblFakDtl.PrsDisc, TblFakDtl.PrsDisc2, TblFakDtl.PrsDisc3, TblFakDtl.Jumlah, TblFak.Kirim, TblFak.NonStock, TblFak.Cetak,tblIvMst.Type
FROM TblFak INNER JOIN TblFakDtl ON TblFak.NoBukti = TblFakDtl.NoBukti INNER JOIN tblIvMst ON TblFakDtl.KdBrg = tblIvMst.KdBrg
Where TblFak.NonStock='0' and  tblIvMst.Type='D4'
ORDER by TblFak.Tgl DESC ";
$myQry = mssql_query($mySql, $koneksidb)  or die ("Query 1 salah : ".mysql_error());
  }
