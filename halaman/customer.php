    ...
    <div class="jumbotron">
        <form action="" method="post" onSubmit="return validasi()">
          ...
          $data = $user;
                ...
                <input type="form-text" class="form-control" name="txtcari" id="txtcari" value="<?php echo $txtcari; ?>"
                    placeholder="Kode Customer">
                <label>Nama Customer :</label>
                <input type="form-text" class="form-control" name="txtcari1" id="txtcari"
                    value="<?php echo $txtcari1; ?>" placeholder="Nama Customer">
                <label>Kode Sales :</label>
                <input type="hidden" class="form-control" name="txtcari2" id="txtcari" value=""
