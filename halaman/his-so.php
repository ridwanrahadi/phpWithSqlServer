...
<script>
  ...
  <?php if ($LevelLogin == "admin") {
    ...
    <label >Input :</label>
    <input type="form-text" class="form-control" name="txtcari2"  value="<?php echo $nmcust; ?>" placeholder="Nama Customer">
  ...
  $txtcari3 = $_POST['txtcari3'];
    ...
    $mySql = "SELECT TOP 1000 salesorder.no_so, salesorder.no_po, salesorder.tgl_so, salesorder.jam, tblCustomer.NmCust, salesorder.grandtotal, salesorder.approved, salesorder.keterangan2,salesorder.kd_user,salesorder.batal,salesorder.proses,TblFak.NoBukti
...
?>
  ...
  <tr>
    <td><a href="#modal-detail" data-id='<?php echo $kolomData['no_so']; ?>' data-toggle='modal'><?php echo $kolomData['no_so']; ?></a></td>
  ...
  <td class='text-center'><a href="?page=Data_SalesOrder&Act=DeleteSo&id=<?php echo $id; ?>" target="_self"><i class='btn btn-primary'>Delete</i></a></td>
    <td><?php if ($NoBukti=='') {
